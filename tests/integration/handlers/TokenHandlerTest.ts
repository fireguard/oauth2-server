...
import { UnsupportedGrantTypeException } from '../../../src/exceptions/UnsupportedGrantTypeException';
import { PasswordGrantType } from '../../../src/grant-types/PasswordGrantType';
import { TokenHandler } from '../../../src/handlers/TokenHandler';
import { Request } from '../../../src/Request';
import { Response } from '../../../src/Response';
import { BearerTokenType } from '../../../src/token-types/BearerTokenType';
...
describe('TokenHandler integration', () => {
  ...
  describe('handleGrantType()', () => {
    ...
    it('should throw an error if `grant_type` is unsupported', async () => {
      ...
      try {
        ...
        e.should.be.an.instanceOf(UnsupportedGrantTypeException);
        e.message.should.equal(
    ...
    /*    it('should throw an invalid grant error if a non-oauth error is thrown', () => {
      ...
      return handler
        ...
        .catch(e => {
          e.should.be.an.instanceOf(InvalidGrantException);
  ...
  describe('updateErrorResponse()', () => {
    it('should set the `body`', () => {
      const error = new AccessDeniedException('Cannot request a token');
      const model = {
        getClient() {},
        saveToken() {},
      };

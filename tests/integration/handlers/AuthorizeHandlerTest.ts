...
import { AccessDeniedException } from '../../../src/exceptions/AccessDeniedException';
import { InvalidArgumentException } from '../../../src/exceptions/InvalidArgumentException';
import { InvalidClientException } from '../../../src/exceptions/InvalidClientException';
import { InvalidRequestException } from '../../../src/exceptions/InvalidRequestException';
import { InvalidScopeException } from '../../../src/exceptions/InvalidScopeException';
import { ServerException } from '../../../src/exceptions/ServerException';
import { UnauthorizedClientException } from '../../../src/exceptions/UnauthorizedClientException';
import { UnsupportedResponseTypeException } from '../../../src/exceptions/UnsupportedResponseTypeException';
import { AuthenticateHandler } from '../../../src/handlers/AuthenticateHandler';
import { AuthorizeHandler } from '../../../src/handlers/AuthorizeHandler';
import { Request } from '../../../src/Request';
import { Response } from '../../../src/Response';
import { CodeResponseType } from '../../../src/response-types/CodeResponseType';
...
describe('AuthorizeHandler integration', () => {
  describe('constructor()', () => {
    it('should throw an error if `options.authorizationCodeLifetime` is missing', () => {
      try {
        ...
        e.should.be.an.instanceOf(InvalidArgumentException);
  ...
  describe('handle()', () => {
    ...
    it('should throw an error if `allowed` is `false`', () => {
      ...
      return handler
        ...
        .catch(e => {
          e.should.be.an.instanceOf(AccessDeniedException);
          e.message.should.equal(
    ...
    it('should redirect to an error response if an oauth error is thrown', () => {
      const model = {
        ...
        saveAuthorizationCode: () => {
          throw new AccessDeniedException('Cannot request this auth code');
        },
      };
      const handler = new AuthorizeHandler({
        authorizationCodeLifetime: 120,
  ...
  describe('getClient()', () => {
    it('should throw an error if `client_id` is missing', async () => {
      ...
      try {
        ...
        e.should.be.an.instanceOf(InvalidRequestException);
    ...
    it('should throw an error if `client` is missing', () => {
      ...
      return handler
        ...
        .then(() => should.fail('should.fail', ''))
        .catch(e => {
          e.should.be.an.instanceOf(InvalidClientException);
          e.message.should.equal(
    ...
    it('should throw an error if `client` is unauthorized', () => {
      ...
      return handler
        ...
        .then(() => should.fail('should.fail', ''))
        .catch(e => {
          e.should.be.an.instanceOf(UnauthorizedClientException);
          e.message.should.equal(
  ...
  describe('getScope()', () => {
    it('should throw an error if `scope` is invalid', () => {
      ...
      try {
        ...
        e.should.be.an.instanceOf(InvalidScopeException);
  ...
  describe('getUser()', () => {
    it('should throw an error if `user` is missing', () => {
      ...
      return handler
        ...
        .then(() => should.fail('should.fail', ''))
        .catch(e => {
          e.should.be.an.instanceOf(ServerException);
          e.message.should.equal(
  ...
  describe('getResponseType()', () => {
    ...
    it('should throw an error if `response_type` is not `code`', () => {
      ...
      try {
        ...
        e.should.be.an.instanceOf(UnsupportedResponseTypeException);
        e.message.should.equal(
  ...
  describe('buildErrorRedirectUri()', () => {
    it('should set `error_description` if available', () => {
      const error = new InvalidClientException('foo bar');
      const model = {
        getAccessToken() {},
        getClient() {},
        saveAuthorizationCode() {},

...
import { InsufficientScopeException } from '../../../src/exceptions/InsufficientScopeException';
...
import { UnauthorizedRequestException } from '../../../src/exceptions/UnauthorizedRequestException';
...
describe('AuthenticateHandler integration', () => {
  ...
  describe('handle()', () => {
    ...
    it('should set the `WWW-Authenticate` header if an unauthorized request error is thrown', () => {
      const model = {
        getAccessToken() {
          throw new UnauthorizedRequestException(undefined, undefined);
        },
      };
    ...
    it('should throw the error if an oauth error is thrown', () => {
      const model = {
        getAccessToken() {
          throw new AccessDeniedException('Cannot request this access token');
        },
      };
      const handler = new AuthenticateHandler({ model });
      const request = new Request({
  ...
  describe('getTokenFromRequest()', () => {
    ...
    it('should throw an error if `accessToken` is missing', () => {
      ...
      try {
        ...
        e.should.be.an.instanceOf(UnauthorizedRequestException);
  ...
  describe('getAccessToken()', () => {
    it('should throw an error if `accessToken` is missing', () => {
      ...
      return handler
        ...
        .then(() => should.fail('should.fail', ''))
        .catch(e => {
          e.should.be.an.instanceOf(InvalidTokenException);
  ...
  describe('verifyScope()', () => {
    it('should throw an error if `scope` is insufficient', () => {
      ...
      return handler
        ...
        .then(() => should.fail('should.fail', ''))
        .catch(e => {
          e.should.be.an.instanceOf(InsufficientScopeException);
          e.message.should.equal(
